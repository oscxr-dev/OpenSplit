...
export function ErrorState({
  ...
  return (
    ...
    >
      ...
      <h3 className="mb-1 text-lg font-medium text-white/85">{t('common.error')}</h3>
      <p className="mb-6 max-w-sm text-sm text-white/40">{message ?? t('common.somethingWentWrong')}</p>
      {onRetry && (
